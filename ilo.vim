...
" Keywords
syntax keyword iloKeywords import var def if else dup swap over rot drop syscall derefc derefi derefb derefp buffer setc seti setb setp const and or while castc casti castb castp location
